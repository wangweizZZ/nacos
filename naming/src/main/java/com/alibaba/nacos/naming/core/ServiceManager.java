...
public class ServiceManager implements RecordListener<Service> {
    ...
    public void init() {
        ...
        GlobalExecutor.scheduleServiceSynchronization(new ServiceReporter(), 60000, TimeUnit.MILLISECONDS);
    ...
    private class ServiceReporter implements Runnable {
        ...
        public void run() {
            try {
                ...
                GlobalExecutor.scheduleServiceSynchronization(this, switchDomain.getServiceStatusSynchronizationPeriodMillis(), TimeUnit.MILLISECONDS);
            }
        }
    }
